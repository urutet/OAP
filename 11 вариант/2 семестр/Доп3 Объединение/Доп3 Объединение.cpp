...
enum
{
	BMW = 1, Citroen, Honda, Volkswagen
} listOfManufact;
...
void enter_new()
{
	...
	if (current_size < size)
	{
		...
		cout << "Марка автомобиля (1-BMW, 2-Citroen, 3-Honda, 4-Volkswagen" << endl;
		cin >> current_manufact;
...
void out()
{
	...
	if (sw == 1)
	{
		...
		if (current_manufact == (int)BMW)
		{
			cout << "BMW" << endl;
		}
		else if (current_manufact == (int)Citroen)
		{
			cout << "Citroen" << endl;
		}
		else if (current_manufact == (int)Honda)
		{
			cout << "Honda" << endl;
		}
		else if (current_manufact == (int)Volkswagen)
		{
			cout << "Volkswagen" << endl;
		}
		else
		{
			cout << "Марки автомобиля нет в базе " << endl;
		}
		cout << "Цвет " << endl;
...
void search()
{
	...
	cout << "Введите VIN " << endl;
	cin >> varArray;
	for (int i = 0; i < current_size; i++)
		if (_stricmp(carsList[i].VIN, varArray) == 0)
		{
			cout << endl << "Имя клиента " << endl;
			cout << carsList[i].clientName << endl;
			cout << "Марка автомобиля " << endl;
